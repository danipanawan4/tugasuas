...
import 'package:catatankeuangan_apk/pages/category_page.dart';
import 'package:catatankeuangan_apk/pages/home_page.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: (currentIndex == 0) ? CalendarAppBar(
        accent: const Color.fromARGB(255, 235, 19, 4),
        locale: 'id',
        backButton: false,
        onDateChanged: (value) {
          setState(() {
        ...
        preferredSize: Size.fromHeight(100), child: Container(child: 
      Padding(
